...
import { addOrder as addOrderAction} from '../../../actions/index'
            ...
            <div className="col-lg-12">                                        
                  <form action="#">
                    <Row className="label-container">
                      <div className="label-wrapper" style={activeOption === descriptions.paczka ? {background: '#eee'} : {background: 'none'}}>
                        ...
                        <label className="radio" style={activeOption === descriptions.paczka ? {background: '#eee'} : {background: 'none'}} htmlFor="paczka">
                          <input id="paczka" name="paczka" checked={activeOption === descriptions.paczka} value={descriptions.paczka} onChange={(e) => handleRadioButtonChange(e)} type="radio"/>
                    ...
                    <Row  className="order-wrapper" >    
                      ...
                      <h3>Dodaj zamówienie do listy Twoich zamówień</h3>
                      <button className="read-more" onClick={() => addOrder(activeOption, formData)}  >Dodaj</button>
                </div>
{/*        
...
const mapDispatchToProps = dispatch => ({
  addOrder: (itemType, orderContent) => dispatch(addOrderAction(itemType, orderContent))
})

 
export default connect(null, mapDispatchToProps)(SendParcel);